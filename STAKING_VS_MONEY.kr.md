...
$ATOM은 디파이가 제공하는 수익률 대비 높은 인플레이션율으로 인해 디파이 앱에서 사용하기
...
ICS 트랜잭션의 확장으로 인해 트랜잭션 수수료로부터 발생하는 보상이 $ATOM의 인플레이션율
...
3/ 충분한 연구 및 논의 없이 $ATOM의 최대 인플레이션율에 반감기를 도입하는 결정은 바람직
